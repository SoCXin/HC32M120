 ...
 **
 ** Auto generate.
 ** Headerfile for HC32M120F6TB series MCU
 **
 ** History:
 **
 **   - 2020-11-19  1.0   First version for Device Driver Library of HC32M120F6TB series MCU.
 **
 ******************************************************************************/
 ...
 ******************************************************************************/
#define __MPU_PRESENT             0       /*!< HC32M120F6TB provides an MPU                             */
...
typedef struct
{
    __IO uint16_t CHSELA                    : 8;
    uint16_t RESERVED8                      : 8;
} stc_adc_chselra0_field_t;

typedef struct
{
    __IO uint16_t CHSELB                    : 8;
    uint16_t RESERVED8                      : 8;
...
#define ADC_CHSELRA0_CHSELA                  ((uint16_t)0x00FFU)
...
#define ADC_CHSELRB0_CHSELB                  ((uint16_t)0x00FFU)
